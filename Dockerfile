...
RUN \
    ...
    && tar -xf arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi.tar.xz -C /usr/share
ENV PATH=/usr/share/arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi/bin:$PATH
